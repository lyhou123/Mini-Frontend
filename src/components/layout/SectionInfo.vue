...
import switchesImage from '/images/switch-array.webp'
</script>
		...
		>
			...
			>
				...
				<p class="mt-10 tracking-wide text-black opacity-70 md:mt-6">
					Located at the heart of Berlin City, CAMBO is the premier store for
					high end keyboards, keycaps, desk mats and other CAMBO accessories.
					We have a large showroom and luxury demonstration rooms available for
					you to browse and experience a wide range of our products. <br />
					<br />
					Stop by our store to meet some of the fantastic people who make CAMBO
