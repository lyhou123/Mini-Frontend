...
<template>
	...
	>
		...
		>
			...
			>
				<p
					class="mb-10 text-center text-white tracking-wide opacity-70 md:mb-0 md:w-2/3 md:text-left"
				>
					CAMBO is an all in one stop to fulfill your mechanical keyboard
