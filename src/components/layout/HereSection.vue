...
import mxupImage from '/product/up-nobg.webp'
</script>

<template>
	<section
		class="flex w-full bg-black flex-col items-center overflow-hidden rounded-b-md bg-k-black"
	>
		<div
		...
		>
			...
			>
				...
				<p class="mb-10 mt-5 md:opacity-90 text-white">
