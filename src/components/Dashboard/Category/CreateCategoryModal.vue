<template>
    <div v-if="props.isOpen" class="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div class="bg-white  rounded-lg shadow-xl p-6 w-full max-w-lg z-50">
        <h3 class="text-2xl font-semibold text-gray-800 mb-4">Create Product Category</h3>
        ...
        <Form @submit="handleSubmit" :validation-schema="schema">
          ...
          <div class="flex justify-end space-x-4">
            <button
              type="button"
              @click="closeModal"
              class="cursor-pointer bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-300"
            >
              Cancel
            </button>
            <button
              type="submit"
              class="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-300 cursor-pointer "
            >
              Create
            </button>
          </div>
